...
if name == 'Grocery':
    filter_size = 15
    read_from_amazon('Grocery_and_Gourmet_Food.json')
    # avg items:  25.30904656657267
    # total items:  48594
    # total behaviors:  332080
    # total users:  13121
    # Density:  0.0005208265746094717
elif name == 'tmall':
    filter_size = 10
    read_from_tmall('tmall-click.inter')
    # avg items:  56.298248192616136
    # total items:  451631
    # total behaviors:  18385713
    # total users:  326577
    # Density:  0.0001246554115917998
elif name == 'gowalla10':
    filter_size = 10
    read_from_gowalla('gowalla.inter')
    # avg items:  34.28000344867226
    # total items:  57445
    # total behaviors:  1192807
    # total users:  34796
    # Density:  0.0005967447723678695
...
print('Density: ', (total_train + total_valid + total_test) / (len(filter_user_ids) * item_total))